...
public class PlayerController : MonoBehaviour
{
    ...
    void Start()
    {
        //Find the Rigidbody2D component that is attactched to the same object as this script
 ...
 //Create a float that will be equal to the players horizontal input
       float movementValueX = 1.0f;
        ...
        //Change the X velocity to the Rigidbody2D to be equal to the movement value
        ...
        {
            playerObject.AddForce(new Vector2(0.0f, 350f));
